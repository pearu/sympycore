...
def test_expand():
    ...
    assert str(((x+y+z)**3).expand()) in ['3*x*y**2 + 3*x*z**2 + 3*y*x**2 + 3*y*z**2 + 3*z*x**2 + 3*z*y**2 + 6*x*y*z + x**3 + y**3 + z**3',
                                          ...
                                          '3*x**2*z + 3*y*x**2 + 3*y*z**2 + 3*x*z**2 + 3*y**2*z + z**3 + x**3 + 6*y*x*z + 3*y**2*x + y**3',
                                          '3*x**2*z + 3*y*x**2 + 3*y*z**2 + x**3 + 3*y**2*z + z**3 + 6*y*x*z + 3*y**2*x + 3*x*z**2 + y**3',
                                          '3*x**2*z + 3*y**2*x + x**3 + 3*x*z**2 + z**3 + 6*y*x*z + 3*y*z**2 + 3*y*x**2 + 3*y**2*z + y**3',
                                          '3*x**2*z + 3*y*x**2 + 3*y*z**2 + 3*x*z**2 + 3*y**2*z + z**3 + 6*y*x*z + 3*y**2*x + x**3 + y**3',
                                          '3*x**2*z + 3*y*x**2 + 3*y*z**2 + x**3 + 3*y**2*z + z**3 + 6*y*x*z + 3*y**2*x + y**3 + 3*x*z**2',
                                          '3*x**2*z + 3*y**2*x + x**3 + 3*y**2*z + z**3 + 6*y*x*z + 3*y*z**2 + 3*x*z**2 + 3*y*x**2 + y**3',
                                          '3*x**2*z + 3*y**2*x + 3*y*z**2 + 3*x*z**2 + 3*y**2*z + x**3 + z**3 + 6*y*x*z + 3*y*x**2 + y**3',
                                          '3*x**2*z + 3*y**2*x + 3*y*z**2 + 3*x*z**2 + x**3 + 3*y**2*z + z**3 + 6*y*x*z + 3*y*x**2 + y**3',
                                          '3*x**2*z + 3*x*z**2 + 3*y**2*x + x**3 + 3*y**2*z + 3*y*x**2 + z**3 + 6*y*x*z + 3*y*z**2 + y**3',
                                          '3*x**2*z + 3*y**2*x + 3*y*z**2 + 3*x*z**2 + 3*y**2*z + z**3 + 6*y*x*z + 3*y*x**2 + x**3 + y**3',
                                          '3*x*z**2 + 3*x**2*z + 3*y**2*x + x**3 + 3*y**2*z + z**3 + 6*y*x*z + 3*y*z**2 + 3*y*x**2 + y**3',
                                          '3*x**2*z + x**3 + 3*y*x**2 + 3*y*z**2 + 3*x*z**2 + 3*y**2*z + z**3 + 6*y*x*z + 3*y**2*x + y**3',
                                          '3*x**2*z + 3*y**2*x + x**3 + 3*y**2*z + z**3 + 6*y*x*z + 3*x*z**2 + 3*y*z**2 + 3*y*x**2 + y**3'],\
                                          str(((x+y+z)**3).expand())
    ...
    assert str(((1+x+y)**3).expand()) in ['1 + x**3 + y**3 + 3*x + 3*x**2 + 3*x*y**2 + 3*y + 3*y**2 + 3*y*x**2 + 6*x*y',
                                          ...
                                          '1 + 3*y*x**2 + 3*x**2 + x**3 + 3*y**2*x + 3*y + 3*x + 3*y**2 + 6*y*x + y**3',
                                          '1 + 3*y**2*x + 3*x**2 + x**3 + 3*y*x**2 + 3*y + 3*x + 6*y*x + 3*y**2 + y**3',
                                          '1 + 3*x**2 + x**3 + 3*y**2*x + 3*y*x**2 + 3*y + 3*x + 3*y**2 + 6*y*x + y**3',
                                          '1 + 3*x**2 + 3*y*x**2 + 3*y**2*x + 3*y + 3*x + 3*y**2 + 6*y*x + x**3 + y**3',
                                          '1 + 3*x**2 + x**3 + 3*y*x**2 + 3*y + 3*x + 3*y**2 + 6*y*x + 3*y**2*x + y**3'],\
                                          str(((1+x+y)**3).expand())
